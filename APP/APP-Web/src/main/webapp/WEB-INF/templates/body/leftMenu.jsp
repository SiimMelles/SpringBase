...
<c:set var = "ScheduleControllerUri" value = "${pageContext.request.contextPath}/schedule"/>
...
<div id="menu" class="hidden-phone">
	<div id="menuInner">				
		<ul>
			...
			<li><a href="${CourseControllerUri}/search"><i></i><span>Courses</span></a></li>
		...
		<ul>
			...
			<li><a href="${ScheduleControllerUri}/create"><i></i><span>Create Schedule</span></a></li>
		</ul>
		<ul>
            <li class="heading"><span>EMPLOYEES</span></li>
            <li><a href="${EmployeeControllerUri}/create"><i></i><span>New Employee</span></a></li>
            <li><a href="${EmployeeControllerUri}/search"><i></i><span>Search Employees</span></a></li>
        </ul>
		<ul>
			<li class="heading"><span>TRAINERS</span></li>
			<li><a href="${TrainerControllerUri}/create"><i></i><span>Create Trainer</span></a></li>
			<li><a href="${TrainerControllerUri}/search"><i></i><span>Search Trainers</span></a></li>
		</ul>
		<ul>
